  ...
  return (
    <main className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="prose prose-slate max-w-none">
        ...
        <h3 className="text-2xl font-semibold mt-6 mb-3">Definitions</h3>
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          ...
          <li>
            <p>
              <strong className="font-semibold">Application</strong> refers to
              Participant Scheduler, the software program provided by the
              Company.
            </p>
          </li>
          <li>
            <p>
              ...
              &quot;Our&quot; in this Agreement) refers to Participant
              Scheduler.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              ...
              Participant Scheduler, accessible from{" "}
              <a
                href="https://participantscheduler.com"
                rel="external nofollow noopener"
                target="_blank"
                className="text-blue-600 hover:underline"
              >
                https://participantscheduler.com
              </a>
            </p>
          </li>
          <li>
        ...
        <ul className="list-disc pl-6 mb-8">
          <li>By email: sethsullivan99@gmail.com</li>
        </ul>
      </div>
    </main>
  );
